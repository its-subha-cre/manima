...
""", unsafe_allow_html=True)
st.markdown("<h2 style='color:#FF69B4;'>### প্রথমে ক্লিক করলে ফাইলগুলো স্বয়ংক্রিয়ভাবে ডাউনলোড হয়ে যাবে আপনাদের ফোনের ফাইলস ফোল্ডারে</h2>", unsafe_allow_html=True)
